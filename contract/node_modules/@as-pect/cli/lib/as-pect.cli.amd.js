...
define("run", ["require", "exports", "fs", "perf_hooks", "path", "chalk", "@as-pect/core", "glob", "util/collectReporter", "util/getTestEntryFiles", "util/writeFile", "@as-pect/core/lib/util/timeDifference", "@as-pect/snapshots", "util/removeFile"], function (require, exports, fs, perf_hooks_1, path, chalk_5, core_1, glob_2, collectReporter_1, getTestEntryFiles_1, writeFile_1, timeDifference_1, snapshots_1, removeFile_1) {
    ...
    function run(cliOptions, compilerArgs) {
         ...
         */
        if (configuration.nortrace) {
            console.log(chalk_5.default(templateObject_32 || (templateObject_32 = __makeTemplateObject(["{bgWhite.black [Log]} Reference Tracing is disabled."], ["{bgWhite.black [Log]} Reference Tracing is disabled."]))));
        }
        /**
        ...
        if (!runTests) {
            console.log(chalk_5.default(templateObject_33 || (templateObject_33 = __makeTemplateObject(["{bgWhite.black [Log]} Not running tests, only outputting files."], ["{bgWhite.black [Log]} Not running tests, only outputting files."]))));
        }
        /**
        ...
        if (!Number.isInteger(memorySize) || memorySize <= 0) {
            console.error(chalk_5.default(templateObject_34 || (templateObject_34 = __makeTemplateObject(["{red [Error]} Invalid {yellow memorySize} value (", ") [valid range is a positive interger]"], ["{red [Error]} Invalid {yellow memorySize} value (", ") [valid range is a positive interger]"])), memorySize));
            process.exit(1);
        }
        if (!Number.isInteger(memoryMax) || memoryMax < -1) {
            console.error(chalk_5.default(templateObject_35 || (templateObject_35 = __makeTemplateObject(["{red [Error]} Invalid {yellow memoryMax} value (", ") [valid range is a positive interger greater than {yellow memorySize}]"], ["{red [Error]} Invalid {yellow memoryMax} value (", ") [valid range is a positive interger greater than {yellow memorySize}]"])), memoryMax));
            process.exit(1);
        }
        if (memoryMax > 0 && memoryMax < memorySize) {
            console.error(chalk_5.default(templateObject_36 || (templateObject_36 = __makeTemplateObject(["{red [Error]} Invalid module memory configuration, memorySize (", ") is greater than memoryMax (", ")."], ["{red [Error]} Invalid module memory configuration, memorySize (", ") is greater than memoryMax (", ")."])), memorySize, memoryMax));
            process.exit(1);
        }
        /**
        ...
        function runBinary(error, file, binary) {
            ...
            if (runTests) {
                ...
                if (typeof configurationImports === "function") {
                    ...
                    if (!result) {
                        console.error(chalk_5.default(templateObject_43 || (templateObject_43 = __makeTemplateObject(["{red [Error]} Imports configuration function did not return an AssemblyScript module. (Did you forget to return it?)"], ["{red [Error]} Imports configuration function did not return an AssemblyScript module. (Did you forget to return it?)"]))));
                        process.exit(1);
                    }
                }
                else {
            ...
            if (count === 0) {
                if (runTests) {
                    ...
                    console.log(chalk_5.default(templateObject_47 || (templateObject_47 = __makeTemplateObject(["  [Result]: ", "\n   [Files]: ", " total\n  [Groups]: ", " count, ", " pass\n   [Tests]: ", " pass, ", " fail, ", " total\n    [Time]: ", "ms"], ["  [Result]: ", "\n   [Files]: ", " total\n  [Groups]: ", " count, ", " pass\n   [Tests]: ", " pass, ",
