    ...
    function runBinary(error, file, binary) {
        ...
        if (runTests) {
            ...
            if (typeof configurationImports === "function") {
                ...
                if (!result) {
                    console.error(chalk_1.default(templateObject_26 || (templateObject_26 = __makeTemplateObject(["{red [Error]} Imports configuration function did not return an AssemblyScript module. (Did you forget to return it?)"], ["{red [Error]} Imports configuration function did not return an AssemblyScript module. (Did you forget to return it?)"]))));
                    process.exit(1);
                }
            }
            else {
        ...
        if (count === 0) {
            if (runTests) {
                ...
                var result = failed ? chalk_1.default(templateObject_27 || (templateObject_27 = __makeTemplateObject(["{red \u2716 FAIL}"], ["{red \u2716 FAIL}"]))) : chalk_1.default(templateObject_28 || (templateObject_28 = __makeTemplateObject(["{green \u2714 PASS}"], ["{green \u2714 PASS}"])));
                try {
                ...
                console.log(chalk_1.default(templateObject_30 || (templateObject_30 = __makeTemplateObject(["  [Result]: ", "\n   [Files]: ", " total\n  [Groups]: ", " count, ", " pass\n   [Tests]: ", " pass, ", " fail, ", " total\n    [Time]: ", "ms"], ["  [Result]: ", "\n   [Files]: ", " total\n  [Groups]: ", " count, ", " pass\n   [Tests]: ", " pass, ",
