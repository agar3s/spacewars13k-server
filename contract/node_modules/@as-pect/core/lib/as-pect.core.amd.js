    ...
    var TestContext = /** @class */ (function () {
        function TestContext(props) {
            ...
            this.rtrace = new rTrace_1.Rtrace({
                ...
                // @ts-ignore
                onerror: function (err, info) { return _this.onRtraceError(err, info); },
                oninfo: function (msg) { return _this.onRtraceInfo(msg); },
            });
            if (props.fileName)
        ...
        TestContext.prototype.endRTrace = function (label) {
            var result = this.rtrace.blocks.size - this.rtraceLabels.get(label);
         ...
         * @param newBlock
         */
        TestContext.prototype.onmove = function (oldBlock, newBlock) {
            this.moveCount += 1;
         ...
         */
        TestContext.prototype.getRTraceMoves = function () {
            return this.moveCount;
        };
        /**
         * This linked method gets all the RTrace reallocations for the current TestNode.
         */
        TestContext.prototype.getRTraceNodeMoves = function () {
        ...
        TestContext.prototype.getRTraceBlocks = function () {
            return this.wasm.__allocArray(this.wasm.__getUsizeArrayId(), Array.from(this.rtrace.blocks.keys()));
        };
        /**
        ...
        TestContext.prototype.onresize = function (_block, _size) {
