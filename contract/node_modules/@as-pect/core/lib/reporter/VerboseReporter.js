...
var VerboseReporter = /** @class */ (function () {
    ...
    VerboseReporter.prototype.onFinish = function (suite) {
        ...
        var rTrace = rtcount === 0
            ? /* istanbul ignore next */
                ""
            : /* istanbul ignore next */ chalk(templateObject_10 || (templateObject_10 = __makeTemplateObject([" {yellow RTrace: ", "}"], [" {yellow RTrace: "
                /* istanbul ignore next */
                ,
                "}"])), 
            /* istanbul ignore next */
        ...
        try {
            ...
            for (var _f = __values(suite.warnings), _g = _f.next(); !_g.done; _g = _f.next()) {
                ...
                /* istanbul ignore next */
                this.stdout.write(chalk(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n{yellow  [Warning]}: ", " -> ", "\n"], ["\\n{yellow  [Warning]}: ", " -> ", "\\n"])), warning.type, warning.message));
                /* istanbul ignore next */
                var stack = warning.stackTrace.trim();
                /* istanbul ignore next */
                if (stack) {
                    /* istanbul ignore next */
                    this.stdout.write(chalk(templateObject_12 || (templateObject_12 = __makeTemplateObject(["{yellow    [Stack]}: {yellow ", "}\n"], ["{yellow    [Stack]}: {yellow ",
                        "}\\n"])), stack
                        .split("\n")
                        .join("\n      ")));
                }
        ...
        try {
            for (var _k = __values(diff.entries()), _l = _k.next(); !_l.done; _l = _k.next()) {
                ...
                if (result_1.type !== 0 /* NoChange */) {
                    this.stdout.write(chalk(templateObject_15 || (templateObject_15 = __makeTemplateObject(["{red [Snapshot]}: ", "\n"], ["{red [Snapshot]}: ", "\\n"])), name_1));
                            ...
                            try {
                                for (var lines_1 = (e_8 = void 0, __values(lines)), lines_1_1 = lines_1.next(); !lines_1_1.done; lines_1_1 = lines_1.next()) {
                                    ...
                                    if (!line.trim())
                                        continue;
                                    if (change.added) {
                                        this.stdout.write(chalk(templateObject_16 || (templateObject_16 = __makeTemplateObject(["{green + ", "}\n"], ["{green + ", "}\\n"])), line));
                                    }
                                    else if (change.removed) {
                                        this.stdout.write(chalk(templateObject_17 || (templateObject_17 = __makeTemplateObject(["{red - ", "}\n"], ["{red - ", "}\\n"])), line));
                                    }
                                    else {
        ...
        this.stdout.write(chalk(templateObject_19 || (templateObject_19 = __makeTemplateObject(["    [File]: ", "", "\n  [Groups]: {green ", " pass}, ", " total\n  [Result]: ", "\n[Snapshot]: ", " total, ", " added, ", " removed, ", " different\n [Summary]: {green ", " pass},  ", ", ", " total\n    [Time]: ", "ms\n\n", "\n\n"], ["    [File]: ", "", "\n  [Groups]: {green ", " pass}, ", " total\n  [Result]: ", "\n[Snapshot]: ", " total, ", " added, ", " removed, ", " different\n [Summary]: {green ", " pass},  ", ", ",
    ...
    VerboseReporter.prototype.onTodo = function (_group, todo) {
        ...
        var chalk = require("chalk");
        /* istanbul ignore next */
        this.stdout.write(chalk(templateObject_20 || (templateObject_20 = __makeTemplateObject(["    {yellow [Todo]:} ", "\n"], ["    {yellow [Todo]:} ", "\\n"])), todo));
    };
    /**
    ...
    VerboseReporter.prototype.onLog = function (logValue) {
        ...
        this.stdout.write(chalk(templateObject_21 || (templateObject_21 = __makeTemplateObject(["     {yellow [Log]:} ", "\n"], ["     {yellow [Log]:} ", "\\n"])), output));
        var stack = logValue.stack.trim();
        /* istanbul ignore next */
        if (stack) {
            this.stdout.write(chalk(templateObject_22 || (templateObject_22 = __makeTemplateObject(["   {yellow [Stack]:} ", "\n"], ["   {yellow [Stack]:} ",
                "\\n"])), stack
                .trimLeft()
                .split("\n")
                .join("\n        ")));
